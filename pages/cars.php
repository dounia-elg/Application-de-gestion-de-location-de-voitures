                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        <tr class='hover:bg-gray-100'>
                            ...
                            <td class='px-4 py-2 border text-center'>
                                <a class='bg-green-500 text-white px-3 py-1 rounded text-sm hover:bg-green-600' href='/projet de gestion location/edit-car.php?idvoiture=$row[idvoiture]'>Edit</a>
                                <a class='bg-red-500 text-white px-3 py-1 rounded text-sm hover:bg-red-600' href='/projet de gestion location/delete-car.php?idvoiture=$row[idvoiture]'>Delete</a>
                            </td>
                        </tr>
                        ";
                    }
